...
try:
    ...
    opts["title"] = input(print_color("Enter title: ", 4))
    opts["author"] = input(print_color("Enter author: ", 4))
    opts["url"] = input(print_color("Enter blog URL: ", 4))
    opts["indexdesc"] = input(print_color("Enter home page description: ", 4))
    opts["sidebardesc"] = input(print_color("Enter sidebar description: ", 4))
    opts["footer"] = input(print_color("Enter footer: ", 4))
